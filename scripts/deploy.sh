...
do
  ...
  docker push gcr.io/rss-aggregator-v3/$service:$version
  docker tag rss-aggregator/$service:$version gcr.io/rss-aggregator-v3/$service:latest
  docker push gcr.io/rss-aggregator-v3/$service:latest
