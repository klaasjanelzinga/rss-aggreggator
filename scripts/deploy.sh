...
gcloud auth activate-service-account deployer@rss-aggregator-236707.iam.gserviceaccount.com  --key-file secrets/deployer.json --project rss-aggregator-236707
