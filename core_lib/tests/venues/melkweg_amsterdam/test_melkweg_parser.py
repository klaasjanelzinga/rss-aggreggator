...
from core_lib.venues.melkweg_amsterdam import MelkwegParser, MelkwegProcessor
...
async def test_parse(client_session: ClientSession):
    ...
    assert_that(
        ...
        equal_to("https://s3-eu-west-1.amazonaws.com/static.melkweg.nl/uploads/images/scaled/agenda_thumbnail/25520"),
    )
