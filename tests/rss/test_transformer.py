...
class TestTransformer(unittest.TestCase):
    def test_as_xml(self):
        ...
        assert_that(rss_item.title, equal_to("Vera Event titel [Vera NL-GRN]"))
        ...
        assert_that(
            description,
            matches_regexp('Where: <a href="http://venue-url-vera-groningen">VERA-Groningen .Groningen, NL.</a></p>'),
        )
