...
class TestSpotParser(unittest.TestCase):
    ...
    def test_sample_file(self):
        ...
        results = self.parser.parse(ParsingContext(venue=config.venue(), content=data))
        ...
        assert_that(kamagurka[0].image_url,
                    equal_to('http://junit-test/wp-content/uploads/2019/02/'
        ...
        assert_that(kamagurka[0].venue, equal_to(config.venue()))
