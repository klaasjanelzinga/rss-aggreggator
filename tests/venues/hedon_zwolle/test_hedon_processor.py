...
class TestHedonProcessor(asynctest.TestCase):
    ...
    async def setUp(self) -> None:
        ...
        self.processor = HedonProcessor(event_repository=self.event_repository, venue_repository=self.venue_repository)
